...
head:
  - tag: link
    attrs: {href: 'https://awesome-android-root.zhoe.org/rooting-guides/how-to-root-pixel-phone', rel: canonical}
  - tag: meta
    attrs: {content: article, property: 'og:type'}
  - tag: meta
    attrs: {content: Google Pixel Root Guide, property: 'og:title'}
  - tag: meta
    attrs: {content: 'Root any Google Pixel device with comprehensive guide covering bootloader unlock, factory images, and Magisk installation.', property: 'og:description'}
  - tag: meta
    attrs: {content: 'https://awesome-android-root.zhoe.org/rooting-guides/how-to-root-pixel-phone', property: 'og:url'}
  - tag: meta
    attrs: {content: 'https://awesome-android-root.zhoe.org/images/og/google-pixel.png', property: 'og:image'}
  - tag: meta
  ...
  - tag: meta
    attrs: {content: Google Pixel Root Guide, name: 'twitter:title'}
  - tag: meta
    attrs: {content: 'Root any Google Pixel device with comprehensive guide covering bootloader unlock, factory images, and Magisk installation.', name: 'twitter:description'}
  - tag: meta
    attrs: {content: 'https://awesome-android-root.zhoe.org/images/og/google-pixel.png', name: 'twitter:image'}
  - tag: meta
    attrs: {content: Google Pixel Root Guide - Bootloader Unlock & Magisk Installation, name: 'twitter:image:alt'}
  - tag: meta
  ...
  - tag: meta
    attrs: {content: Google Pixel, property: 'article:tag'}
  - tag: meta
