...
head:
  - tag: link
    attrs: {href: 'https://awesome-android-root.zhoe.org/rooting-guides/how-to-root-oneplus-phone', rel: canonical}
  - tag: meta
    attrs: {content: article, property: 'og:type'}
  - tag: meta
    attrs: {content: Complete OnePlus Rooting Guide - All Models Supported, property: 'og:title'}
  - tag: meta
    attrs: {content: 'Root any OnePlus device with our comprehensive guide covering bootloader unlock, MSM tool, custom recovery and Magisk installation for OxygenOS.', property: 'og:description'}
  - tag: meta
    attrs: {content: 'https://awesome-android-root.zhoe.org/rooting-guides/how-to-root-oneplus-phone', property: 'og:url'}
  - tag: meta
    attrs: {content: 'https://awesome-android-root.zhoe.org/images/og/oneplus.png', property: 'og:image'}
  - tag: meta
    attrs: {content: summary_large_image, name: 'twitter:card'}
  - tag: meta
    attrs: {content: Complete OnePlus Rooting Guide - All Models, name: 'twitter:title'}
  - tag: meta
    attrs: {content: Root any OnePlus phone with bootloader unlock and Magisk installation guide., name: 'twitter:description'}
  - tag: meta
    attrs: {content: '@awsm_and_root', name: 'twitter:site'}
  - tag: meta
    attrs: {content: '@awsm_and_root', name: 'twitter:creator'}
  - tag: meta
    attrs: {content: 'https://awesome-android-root.zhoe.org/images/og/oneplus.png', name: 'twitter:image'}
  - tag: meta
    attrs: {content: OnePlus Root Guide - All Models, name: 'twitter:image:alt'}
  - tag: meta
  ...
  - tag: meta
    attrs: {content: OnePlus Root, property: 'article:tag'}
  - tag: meta
    attrs: {content: OxygenOS, property: 'article:tag'}
  - tag: meta
