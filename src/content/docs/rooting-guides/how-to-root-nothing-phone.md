...
head:
  - tag: link
    attrs: {href: 'https://awesome-android-root.zhoe.org/rooting-guides/how-to-root-nothing-phone', rel: canonical}
  - tag: meta
    attrs: {content: article, property: 'og:type'}
  - tag: meta
    attrs: {content: Complete Nothing & CMF by Nothing Phone Rooting Guide - All Models, property: 'og:title'}
  - tag: meta
    attrs: {content: 'Root any Nothing Phone with our comprehensive guide covering bootloader unlock, custom recovery, and Magisk installation for Nothing OS.', property: 'og:description'}
  - tag: meta
    attrs: {content: 'https://awesome-android-root.zhoe.org/rooting-guides/how-to-root-nothing-phone', property: 'og:url'}
  - tag: meta
    attrs: {content: 'https://awesome-android-root.zhoe.org/images/og/nothing.png', property: 'og:image'}
  - tag: meta
    attrs: {content: summary_large_image, name: 'twitter:card'}
  - tag: meta
    attrs: {content: Complete Nothing & CMF by Nothing Phone Rooting Guide - All Models, name: 'twitter:title'}
  - tag: meta
    attrs: {content: Root any Nothing & CMF by Nothing Phone with bootloader unlock and Magisk installation guide., name: 'twitter:description'}
  - tag: meta
    attrs: {content: '@awsm_and_root', name: 'twitter:site'}
  - tag: meta
    attrs: {content: '@awsm_and_root', name: 'twitter:creator'}
  - tag: meta
    attrs: {content: 'https://awesome-android-root.zhoe.org/images/og/nothing.png', name: 'twitter:image'}
  - tag: meta
    attrs: {content: Nothing Phone Root Guide - All Models, name: 'twitter:image:alt'}
  - tag: meta
  ...
  - tag: meta
    attrs: {content: Nothing Phone, property: 'article:tag'}
  - tag: meta
    attrs: {content: Nothing OS, property: 'article:tag'}
  - tag: meta
    attrs: {content: Bootloader Unlock, property: 'article:tag'}
  - tag: meta
    attrs: {content: Magisk Installation, property: 'article:tag'}
  - tag: meta
    attrs: {content: '2025-06-15 00:00:00+00:00', property: 'article:published_time'}
  - tag: meta
