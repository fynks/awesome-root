...
head:
  - tag: link
    attrs: {href: 'https://awesome-android-root.zhoe.org/rooting-guides/lsposed-guide', rel: canonical}
  - tag: meta
    attrs: {content: article, property: 'og:type'}
  - tag: meta
    attrs: {content: Complete LSPosed Framework Guide - Modern Xposed Implementation, property: 'og:title'}
  - tag: meta
    attrs: {content: Install LSPosed framework with our comprehensive guide. Modern Xposed implementation with Zygisk integration and advanced module management., property: 'og:description'}
  - tag: meta
    attrs: {content: 'https://awesome-android-root.zhoe.org/rooting-guides/lsposed-guide', property: 'og:url'}
  - tag: meta
    attrs: {content: 'https://awesome-android-root.zhoe.org/images/og/lsposed-guide.png', property: 'og:image'}
  - tag: meta
  ...
  - tag: meta
    attrs: {content: Complete LSPosed Framework Guide, name: 'twitter:title'}
  - tag: meta
    attrs: {content: Modern Xposed framework implementation with LSPosed. Advanced Android customization and module management., name: 'twitter:description'}
  - tag: meta
    attrs: {content: 'https://awesome-android-root.zhoe.org/images/og/lsposed-guide.png', name: 'twitter:image'}
  - tag: meta
    attrs: {content: LSPosed Framework Installation Guide, name: 'twitter:image:alt'}
  - tag: meta
  ...
  - tag: meta
    attrs: {content: Android Customization, property: 'article:section'}
  - tag: meta
    attrs: {content: LSPosed, property: 'article:tag'}
  - tag: meta
    attrs: {content: Xposed Framework, property: 'article:tag'}
  - tag: meta
    attrs: {content: Android Customization, property: 'article:tag'}
  - tag: meta
    attrs: {content: Zygisk, property: 'article:tag'}
  - tag: meta
