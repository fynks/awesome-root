...
head:
  - tag: link
    attrs: {href: 'https://awesome-android-root.zhoe.org/rooting-guides/how-to-root-xiaomi-phone', rel: canonical}
  - tag: meta
    attrs: {content: article, property: 'og:type'}
  - tag: meta
    attrs: {content: Complete Xiaomi Rooting Guide - All Models Supported, property: 'og:title'}
  - tag: meta
    attrs: {content: 'Root any Xiaomi device with our comprehensive guide covering Mi Unlock Tool, bootloader unlock and Magisk installation for MIUI/HyperOS.', property: 'og:description'}
  - tag: meta
    attrs: {content: 'https://awesome-android-root.zhoe.org/rooting-guides/how-to-root-xiaomi-phone', property: 'og:url'}
  - tag: meta
    attrs: {content: 'https://awesome-android-root.zhoe.org/images/og/xiaomi.png', property: 'og:image'}
  - tag: meta
    attrs: {content: summary_large_image, name: 'twitter:card'}
  - tag: meta
    attrs: {content: Complete Xiaomi Rooting Guide - All Models, name: 'twitter:title'}
  - tag: meta
    attrs: {content: Root any Xiaomi device with Mi Unlock Tool and Magisk installation guide., name: 'twitter:description'}
  - tag: meta
    attrs: {content: '@awsm_and_root', name: 'twitter:site'}
  - tag: meta
    attrs: {content: '@awsm_and_root', name: 'twitter:creator'}
  - tag: meta
    attrs: {content: 'https://awesome-android-root.zhoe.org/images/og/xiaomi.png', name: 'twitter:image'}
  - tag: meta
    attrs: {content: Xiaomi Root Guide - All Models, name: 'twitter:image:alt'}
  - tag: meta
  ...
  - tag: meta
    attrs: {content: Xiaomi Root, property: 'article:tag'}
  - tag: meta
    attrs: {content: MIUI, property: 'article:tag'}
  - tag: meta
    attrs: {content: HyperOS, property: 'article:tag'}
  - tag: meta
    attrs: {content: Mi Unlock Tool, property: 'article:tag'}
  - tag: meta
