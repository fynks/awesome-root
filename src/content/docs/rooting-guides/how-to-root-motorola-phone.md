...
head:
  - tag: link
    attrs: {href: 'https://awesome-android-root.zhoe.org/rooting-guides/how-to-root-motorola-phone', rel: canonical}
  - tag: meta
    attrs: {content: article, property: 'og:type'}
  - tag: meta
    attrs: {content: Complete Motorola Rooting Guide - All Models Supported, property: 'og:title'}
  - tag: meta
    attrs: {content: 'Root any Motorola device with our comprehensive guide covering bootloader unlock codes, Magisk installation, and special A/B partition procedures.', property: 'og:description'}
  - tag: meta
    attrs: {content: 'https://awesome-android-root.zhoe.org/rooting-guides/how-to-root-motorola-phone', property: 'og:url'}
  - tag: meta
    attrs: {content: 'https://awesome-android-root.zhoe.org/images/og/motorola.png', property: 'og:image'}
  - tag: meta
    attrs: {content: summary_large_image, name: 'twitter:card'}
  - tag: meta
    attrs: {content: Complete Motorola Rooting Guide - All Models, name: 'twitter:title'}
  - tag: meta
    attrs: {content: Root any Motorola phone with bootloader unlock codes and Magisk installation guide., name: 'twitter:description'}
  - tag: meta
    attrs: {content: '@awsm_and_root', name: 'twitter:site'}
  - tag: meta
    attrs: {content: '@awsm_and_root', name: 'twitter:creator'}
  - tag: meta
    attrs: {content: 'https://awesome-android-root.zhoe.org/images/og/motorola.png', name: 'twitter:image'}
  - tag: meta
    attrs: {content: Motorola Root Guide - All Models, name: 'twitter:image:alt'}
  - tag: meta
  ...
  - tag: meta
    attrs: {content: Motorola Root, property: 'article:tag'}
  - tag: meta
